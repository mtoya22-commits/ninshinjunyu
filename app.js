        ...
        <div class="rx-table-wrap v29-table-wrap" aria-label="${axisLabel}の薬剤比較表">
          <table class="rx-table v29-table">
            ...
            <tbody>
              ...
              ${row("添付文書", "", (drug) => renderInsertHelpButton(getAxisInsert(drug), currentMode, "rx-mini-chip"))}
      ...
      return `
        <table class="comparison-table">
          ...
          <tbody>
            ...
            <tr>
              <td>妊娠<br>添付文書</td>
              ${drugs.map(drug => `<td>${renderInsertHelpButton(drug.pregnancyInsert, "pregnancy", "rx-mini-chip")}</td>`).join("")}
            </tr>
            <tr>
              <td>授乳<br>総合評価</td>
            ...
            <tr>
              <td>授乳<br>添付文書</td>
              ${drugs.map(drug => `<td>${renderInsertHelpButton(drug.lactationInsert, "lactation", "rx-mini-chip")}</td>`).join("")}
            </tr>
          </tbody>
        </table>
      `;
