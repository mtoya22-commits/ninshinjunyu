const PIN_HASH = "3472adbbcb9677d1b45365d37d96d1c33217d745567577fd9bd5c2766a258320";
        ...
        <div class="rx-table-wrap v29-table-wrap" aria-label="${axisLabel}の薬剤比較表">
          <table class="rx-table v29-table">
            ...
            <tbody>
              ...
              ${row("添付文書", "", (drug) => renderInsertHelpButtonCompact(getAxisInsert(drug), currentMode), "insert-row")}
    ...
    const COMPARISON_GROUPS = [...ANTIBIOTIC_GROUPS, ...ANTIVIRAL_GROUPS, ...ANALGESIC_GROUPS, ...ANTIALLERGY_GROUPS, ...DIABETES_GROUPS, ...LIPID_GROUPS, ...THYROID_GROUPS, ...BONE_GROUPS, ...CV_GROUPS];
