        ...
        <div class="rx-table-wrap v29-table-wrap" aria-label="${axisLabel}の薬剤比較表">
          <table class="rx-table v29-table">
            ...
            <tbody>
              ...
              ${row("添付文書", "", (drug) => `<span class="rx-mini-chip">${escapeHtml(getDisplayInsert(getAxisInsert(drug), currentMode))}</span>`)}
          ...
          <button class="rx-title" type="button" data-drug-id="${escapeHtml(drug.id)}">
            <div>
              ...
              <div class="mini-eval">
                ...
                <span>添付文書：${escapeHtml(getDisplayInsert(getAxisInsert(drug), currentMode))}</span>
              </div>
            </div>
      ...
      return `
        <div class="status-box">
          ...
          <div class="kv">
            ...
            <div class="v">${escapeHtml(getDisplayInsert(insert, axis))}</div>
          </div>
        </div>
      `;
    }
...
// Network-first service worker registration.
    ...
    const APP_VERSION = "20260505-0049";
