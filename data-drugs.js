var DRUGS = [
  ...
  d("famciclovir", "抗ウイルス薬｜ヘルペス", "antiviral_herpes", "ファムシクロビル", "famciclovir", ["ファムビル", "ファムシクロビル"], "有益性", "添文③", "本文参照", "情報なし"),
  d("amenamevir", "抗ウイルス薬｜ヘルペス", "antiviral_herpes", "アメナメビル", "amenamevir", ["アメナリーフ"], "有益性", "添文③", "情報なし", "情報なし"),
  d("molnupiravir", "抗ウイルス薬｜COVID-19", "antiviral_covid", "モルヌピラビル", "molnupiravir", ["ラゲブリオ"], "禁忌", "添文③", "本文参照", "情報なし"),
  d("nirmatrelvir-ritonavir", "抗ウイルス薬｜COVID-19", "antiviral_covid", "ニルマトレルビル・リトナビル", "nirmatrelvir / ritonavir", ["パキロビッド"], "有益性", "添文③", "本文参照", "本文参照"),
  ...
  d("baloxavir", "抗ウイルス薬｜インフルエンザ", "antiviral_flu", "バロキサビル", "baloxavir", ["ゾフルーザ"], "有益性", "添文③", "情報なし", "本文参照"),
  d("favipiravir", "抗ウイルス薬｜インフルエンザ", "antiviral_flu", "ファビピラビル", "favipiravir", ["アビガン"], "禁忌", "添文③", "本文参照", "本文参照"),
  ...
  d("aspirin", "解熱鎮痛薬｜NSAIDs内服", "analgesic_oral_nsaid", "アスピリン", "aspirin", ["バファリン", "アスピリン"], "禁忌", "添文①", "本文参照", "使用可"),
  ...
  d("buprenorphine-patch", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "ブプレノルフィン貼付", "buprenorphine transdermal", ["ノルスパン"], "有益性", "添文①", "使用可", "本文参照"),
  d("tramadol", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "トラマドール", "tramadol", ["トラマール", "ワントラム", "トラムセット"], "有益性", "添文③", "本文参照", "本文参照"),
  d("neurotropin", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "ワクシニアウイルス接種家兎炎症皮膚抽出液", "neurotropin", ["ノイロトロピン"], "有益性", "添文③", "情報なし", "情報なし"),
  d("pregabalin", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "プレガバリン", "pregabalin", ["リリカ"], "有益性", "添文①", "本文参照", "本文参照"),
  d("gabapentin", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "ガバペンチン", "gabapentin", ["ガバペン"], "有益性", "添文③", "本文参照", "使用可"),
  d("mirogabalin", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "ミロガバリン", "mirogabalin", ["タリージェ"], "有益性", "添文③", "情報なし", "情報なし"),
  d("tizanidine", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "チザニジン", "tizanidine", ["テルネリン"], "有益性", "添文③", "本文参照", "情報なし"),
  d("eperisone", "解熱鎮痛薬｜その他鎮痛薬", "analgesic_other_pain", "エペリゾン", "eperisone", ["ミオナール"], "有益性", "添文③", "本文参照", "情報なし"),
  ...
  d("tranilast", "抗アレルギー薬｜メディエーター遊離抑制薬", "antiallergy_mediator", "トラニラスト", "tranilast", ["リザベン"], "禁忌", "添文③", "本文参照", "使用可"),
  ...
  d("insulin-human-regular", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン ヒト", "insulin human", ["ノボリンR", "ヒューマリンR"], "本文参照", "本文参照", "使用可", "使用可"),
  d("insulin-lispro", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン リスプロ", "insulin lispro", ["ヒューマログ", "ルムジェブ"], "本文参照", "本文参照", "使用可", "使用可"),
  d("insulin-aspart", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン アスパルト", "insulin aspart", ["ノボラピッド", "フィアスプ"], "本文参照", "本文参照", "使用可", "使用可"),
  d("insulin-glulisine", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン グルリジン", "insulin glulisine", ["アピドラ"], "有益性", "本文参照", "使用可", "使用可"),
  d("insulin-isophane", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "ヒトイソフェンインスリン", "isophane insulin human", ["ノボリンN", "ヒューマリンN"], "本文参照", "本文参照", "使用可", "使用可"),
  d("insulin-glargine", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン グラルギン", "insulin glargine", ["ランタス"], "有益性", "本文参照", "使用可", "使用可"),
  d("insulin-glargine-bs", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン グラルギンBS", "insulin glargine biosimilar", ["インスリン グラルギンBS"], "有益性", "本文参照", "使用可", "使用可"),
  d("insulin-detemir", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン デテミル", "insulin detemir", ["レベミル"], "本文参照", "本文参照", "使用可", "使用可"),
  d("insulin-degludec", "糖尿病治療薬｜インスリン製剤", "diabetes_insulin", "インスリン デグルデク", "insulin degludec", ["トレシーバ"], "本文参照", "本文参照", "使用可", "使用可"),

  d("metformin", "糖尿病治療薬｜ビグアナイド薬", "diabetes_biguanide", "メトホルミン", "metformin", ["グリコラン", "メトグルコ"], "禁忌", "添文③", "本文参照", "使用可"),
  d("imeglimin", "糖尿病治療薬｜ミトコンドリア機能改善薬", "diabetes_imeglimin", "イメグリミン", "imeglimin", ["ツイミーグ"], "本文参照", "添文③", "情報なし", "情報なし"),
  d("pioglitazone", "糖尿病治療薬｜チアゾリジン誘導体", "diabetes_thiazolidine", "ピオグリタゾン", "pioglitazone", ["アクトス"], "禁忌", "添文③", "本文参照", "本文参照"),

  d("glibenclamide", "糖尿病治療薬｜スルホニルウレア薬", "diabetes_su", "グリベンクラミド", "glibenclamide", ["オイグルコン"], "禁忌", "添文③", "本文参照", "使用可"),
  d("gliclazide", "糖尿病治療薬｜スルホニルウレア薬", "diabetes_su", "グリクラジド", "gliclazide", ["グリミクロン"], "禁忌", "添文③", "本文参照", "情報なし"),
  d("glimepiride", "糖尿病治療薬｜スルホニルウレア薬", "diabetes_su", "グリメピリド", "glimepiride", ["アマリール"], "禁忌", "添文③", "本文参照", "情報なし"),
  ...
  d("repaglinide", "糖尿病治療薬｜速効型インスリン分泌促進薬", "diabetes_glinide", "レパグリニド", "repaglinide", ["シュアポスト"], "禁忌", "添文③", "本文参照", "情報なし"),
  ...
  d("miglitol", "糖尿病治療薬｜α-グルコシダーゼ阻害薬", "diabetes_alpha_gi", "ミグリトール", "miglitol", ["セイブル"], "禁忌", "添文③", "本文参照", "使用可"),

  d("ipragliflozin", "糖尿病治療薬｜SGLT2阻害薬", "diabetes_sglt2", "イプラグリフロジン", "ipragliflozin", ["スーグラ"], "本文参照", "添文②", "情報なし", "情報なし"),
  d("dapagliflozin", "糖尿病治療薬｜SGLT2阻害薬", "diabetes_sglt2", "ダパグリフロジン", "dapagliflozin", ["フォシーガ"], "本文参照", "添文②", "本文参照", "情報なし"),
  d("empagliflozin", "糖尿病治療薬｜SGLT2阻害薬", "diabetes_sglt2", "エンパグリフロジン", "empagliflozin", ["ジャディアンス"], "本文参照", "添文②", "本文参照", "情報なし"),
  d("luseogliflozin", "糖尿病治療薬｜SGLT2阻害薬", "diabetes_sglt2", "ルセオグリフロジン", "luseogliflozin", ["ルセフィ"], "本文参照", "添文②", "情報なし", "情報なし"),
  d("tofogliflozin", "糖尿病治療薬｜SGLT2阻害薬", "diabetes_sglt2", "トホグリフロジン", "tofogliflozin", ["デベルザ"], "本文参照", "添文②", "情報なし", "情報なし"),
  d("canagliflozin", "糖尿病治療薬｜SGLT2阻害薬", "diabetes_sglt2", "カナグリフロジン", "canagliflozin", ["カナグル"], "本文参照", "添文②", "情報なし", "情報なし"),

  d("sitagliptin", "糖尿病治療薬｜DPP-4阻害薬", "diabetes_dpp4", "シタグリプチン", "sitagliptin", ["ジャヌビア", "グラクティブ"], "有益性", "添文③", "本文参照", "情報なし"),
  d("vildagliptin", "糖尿病治療薬｜DPP-4阻害薬", "diabetes_dpp4", "ビルダグリプチン", "vildagliptin", ["エクア"], "有益性", "添文③", "本文参照", "情報なし"),
  ...
  d("liraglutide", "糖尿病治療薬｜GLP-1受容体作動薬", "diabetes_glp1", "リラグルチド", "liraglutide", ["ビクトーザ"], "本文参照", "添文③", "本文参照", "本文参照"),
  d("exenatide", "糖尿病治療薬｜GLP-1受容体作動薬", "diabetes_glp1", "エキセナチド", "exenatide", ["バイエッタ"], "本文参照", "添文③", "本文参照", "本文参照"),
  d("lixisenatide", "糖尿病治療薬｜GLP-1受容体作動薬", "diabetes_glp1", "リキシセナチド", "lixisenatide", ["リキスミア"], "本文参照", "添文③", "情報なし", "本文参照"),
  d("dulaglutide", "糖尿病治療薬｜GLP-1受容体作動薬", "diabetes_glp1", "デュラグルチド", "dulaglutide", ["トルリシティ"], "本文参照", "添文③", "本文参照", "本文参照"),
  d("semaglutide", "糖尿病治療薬｜GLP-1受容体作動薬", "diabetes_glp1", "セマグルチド", "semaglutide", ["オゼンピック", "リベルサス", "ウゴービ"], "本文参照", "添文③", "本文参照", "本文参照"),
  d("tirzepatide", "糖尿病治療薬｜GIP/GLP-1受容体作動薬", "diabetes_gip_glp1", "チルゼパチド", "tirzepatide", ["マンジャロ"], "本文参照", "添文③", "情報なし", "本文参照"),
  d("pravastatin", "脂質異常症治療薬｜スタチン系薬剤", "lipid_statin", "プラバスタチン", "pravastatin", ["メバロチン"], "禁忌", "禁忌", "本文参照", "本文参照"),
  d("simvastatin", "脂質異常症治療薬｜スタチン系薬剤", "lipid_statin", "シンバスタチン", "simvastatin", ["リポバス"], "禁忌", "禁忌", "本文参照", "本文参照"),
  d("fluvastatin", "脂質異常症治療薬｜スタチン系薬剤", "lipid_statin", "フルバスタチン", "fluvastatin", ["ローコール"], "禁忌", "禁忌", "本文参照", "本文参照"),
  d("atorvastatin", "脂質異常症治療薬｜スタチン系薬剤", "lipid_statin", "アトルバスタチン", "atorvastatin", ["リピトール"], "禁忌", "禁忌", "本文参照", "本文参照"),
  d("pitavastatin", "脂質異常症治療薬｜スタチン系薬剤", "lipid_statin", "ピタバスタチン", "pitavastatin", ["リバロ"], "禁忌", "禁忌", "本文参照", "本文参照"),
  d("rosuvastatin", "脂質異常症治療薬｜スタチン系薬剤", "lipid_statin", "ロスバスタチン", "rosuvastatin", ["クレストール"], "禁忌", "禁忌", "本文参照", "本文参照"),

  d("ezetimibe", "脂質異常症治療薬｜小腸コレステロールトランスポーター阻害薬", "lipid_ezetimibe", "エゼチミブ", "ezetimibe", ["ゼチーア"], "有益性", "添文③", "本文参照", "情報なし"),
  ...
  d("thiamazole", "甲状腺疾患治療薬｜抗甲状腺薬", "thyroid_antithyroid", "チアマゾール", "thiamazole", ["メルカゾール"], "有益性", "添文①", "本文参照", "使用可"),
  d("propylthiouracil", "甲状腺疾患治療薬｜抗甲状腺薬", "thyroid_antithyroid", "プロピルチオウラシル", "propylthiouracil", ["チウラジール", "プロパジール"], "有益性", "添文③", "本文参照", "使用可"),
  d("potassium-iodide", "甲状腺疾患治療薬｜無機ヨウ素", "thyroid_iodide", "ヨウ化カリウム", "potassium iodide", ["ヨウ化カリウム"], "有益性", "添文①", "本文参照", "本文参照"),
  d("alfacalcidol", "骨・カルシウム代謝薬｜活性型ビタミンD3製剤", "bone_vitamin_d", "アルファカルシドール", "alfacalcidol", ["ワンアルファ", "アルファロール"], "有益性", "添文③", "使用可", "本文参照"),
  d("eldecalcitol", "骨・カルシウム代謝薬｜活性型ビタミンD3製剤", "bone_vitamin_d", "エルデカルシトール", "eldecalcitol", ["エディロール"], "禁忌", "禁忌", "本文参照", "本文参照"),
  d("calcitriol", "骨・カルシウム代謝薬｜活性型ビタミンD3製剤", "bone_vitamin_d", "カルシトリオール", "calcitriol", ["ロカルトロール"], "有益性", "添文③", "使用可", "本文参照"),
  d("falecalcitriol", "骨・カルシウム代謝薬｜活性型ビタミンD3製剤", "bone_vitamin_d", "ファレカルシトリオール", "falecalcitriol", ["ホーネル", "フルスタン"], "有益性", "添文③", "使用可", "本文参照"),
  d("maxacalcitol", "骨・カルシウム代謝薬｜活性型ビタミンD3製剤", "bone_vitamin_d", "マキサカルシトール", "maxacalcitol", ["オキサロール"], "有益性", "添文③", "使用可", "本文参照"),

  d("etidronate", "骨・カルシウム代謝薬｜ビスホスホネート製剤", "bone_bisphosphonate", "エチドロン酸二ナトリウム", "etidronate disodium", ["ダイドロネル"], "禁忌", "添文③", "本文参照", "使用可"),
  d("alendronate", "骨・カルシウム代謝薬｜ビスホスホネート製剤", "bone_bisphosphonate", "アレンドロン酸ナトリウム", "alendronate sodium", ["フォサマック", "ボナロン"], "有益性", "添文③", "本文参照", "使用可"),
  d("risedronate", "骨・カルシウム代謝薬｜ビスホスホネート製剤", "bone_bisphosphonate", "リセドロン酸ナトリウム", "risedronate sodium", ["ベネット", "アクトネル"], "禁忌", "添文③", "本文参照", "使用可"),
  d("ibandronate", "骨・カルシウム代謝薬｜ビスホスホネート製剤", "bone_bisphosphonate", "イバンドロン酸ナトリウム", "ibandronate sodium", ["ボンビバ"], "禁忌", "添文③", "本文参照", "使用可"),
  d("minodronate", "骨・カルシウム代謝薬｜ビスホスホネート製剤", "bone_bisphosphonate", "ミノドロン酸", "minodronic acid", ["ボノテオ", "リカルボン"], "禁忌", "添文③", "本文参照", "使用可"),
  ...
  d("spironolactone", "循環器｜降圧薬｜ミネラルコルチコイド受容体拮抗薬", "cv_mra", "スピロノラクトン", "spironolactone", ["アルダクトン"], "有益性", "添文③", "本文参照", "使用可"),
  ...
  d("atenolol", "循環器｜降圧薬｜β遮断薬", "cv_beta", "アテノロール", "atenolol", ["テノーミン"], "有益性", "添文④", "本文参照", "本文参照"),
  d("metoprolol", "循環器｜降圧薬｜β遮断薬", "cv_beta", "メトプロロール", "metoprolol", ["ロプレソール", "セロケン"], "禁忌", "添文③", "本文参照", "使用可"),
  d("bisoprolol", "循環器｜降圧薬｜β遮断薬", "cv_beta", "ビソプロロール", "bisoprolol", ["メインテート"], "有益性", "添文③", "本文参照", "使用可"),
  d("celiprolol", "循環器｜降圧薬｜β遮断薬", "cv_beta", "セリプロロール", "celiprolol", ["セレクトール"], "禁忌", "添文②", "本文参照", "使用可"),
  d("betaxolol", "循環器｜降圧薬｜β遮断薬", "cv_beta", "ベタキソロール", "betaxolol", ["ケルロング"], "禁忌", "添文③", "本文参照", "使用可"),
  d("propranolol", "循環器｜降圧薬｜β遮断薬", "cv_beta", "プロプラノロール", "propranolol", ["インデラル"], "有益性", "添文③", "本文参照", "使用可"),
  ...
  d("furosemide", "循環器｜利尿剤｜ループ利尿薬", "cv_diuretic_loop", "フロセミド", "furosemide", ["ラシックス"], "有益性", "添文②", "本文参照", "使用可"),
  d("azosemide", "循環器｜利尿剤｜ループ利尿薬", "cv_diuretic_loop", "アゾセミド", "azosemide", ["ダイアート"], "有益性", "添文③", "本文参照", "本文参照"),
  d("hydrochlorothiazide", "循環器｜利尿剤｜サイアザイド系利尿薬", "cv_diuretic_thiazide", "ヒドロクロロチアジド", "hydrochlorothiazide", ["ヒドロクロロチアジド"], "有益性", "添文②", "本文参照", "使用可"),
  d("trichlormethiazide", "循環器｜利尿剤｜サイアザイド系利尿薬", "cv_diuretic_thiazide", "トリクロルメチアジド", "trichlormethiazide", ["フルイトラン"], "有益性", "添文②", "本文参照", "本文参照"),

  d("codeine-phosphate", "呼吸器｜鎮咳去痰｜中枢性麻薬性鎮咳薬", "resp_cough", "コデインリン酸塩水和物", "codeine phosphate hydrate", ["コデインリン酸塩", "コデイン"], "有益性", "添文①", "本文参照", "本文参照"),
  d("dihydrocodeine-phosphate", "呼吸器｜鎮咳去痰｜中枢性麻薬性鎮咳薬", "resp_cough", "ジヒドロコデインリン酸塩", "dihydrocodeine phosphate", ["ジヒドロコデインリン酸塩", "ジヒドロコデイン"], "有益性", "添文①", "本文参照", "本文参照"),
  ...
  d("domperidone", "消化器｜上部消化管｜ドパミン受容体拮抗薬", "gi_upper", "ドンペリドン", "domperidone", ["ナウゼリン"], "禁忌", "添文③", "本文参照", "使用可"),
  d("itopride", "消化器｜上部消化管｜ドパミン受容体拮抗薬", "gi_upper", "イトプリド", "itopride", ["ガナトン"], "有益性", "添文③", "本文参照", "使用可"),
  ...
  d("mepenzolate", "消化器｜下部消化管｜過敏性腸症候群治療薬", "gi_lower", "メペンゾラート臭化物", "mepenzolate bromide", ["メペンゾラート"], "有益性", "添文③", "使用可", "本文参照"),
